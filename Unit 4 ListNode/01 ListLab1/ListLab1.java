...
public class ListLab1
{
   ...
   {
      return (arg.getNext()!=null)?(new ListNode(arg.getValue(), copyList(arg.getNext()))):(new ListNode(arg.getValue(), null));
   }
   ...
   public static ListNode rest(ListNode h)
   {
      if (h.getNext() == null)
         ...
         return (h.getNext().getNext()!=null)?(new ListNode(h.getNext().getValue(), rest(h.getNext()))):(new ListNode(h.getNext().getValue(), null));
   }
   ...
   public static Object second(ListNode head){
      return (head.getNext() != null && head.getNext().getNext() != null) ? (head.getNext().getValue()) : null;
   }
   ...
   public static ListNode copyOfLast(ListNode head){
      ...
      while (p != null){
         if (p.getNext() == null)
            return new ListNode(p.getValue(), null);
         p = p.getNext();
      }
      return null;
   }
   ...
   public static ListNode insertLast(ListNode head, Object arg){
      ...
      ListNode obj = new ListNode(arg, null);
      p.setNext(obj);
      return head;
   }
}
